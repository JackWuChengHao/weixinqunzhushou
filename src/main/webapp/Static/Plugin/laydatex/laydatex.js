; !function(a) {
    ...
    h = ["laydatex_box", "laydatex_void", "laydatex_click", "laydatexSkin", "skins/", "/laydatex.css"];
    a.laydatex = function(b) {
        b = b || {};
        try {
            h.event = a.event ? a.event: laydatex.caller.arguments[0]
        } catch(d) {}
        return c.run(b),
        laydatex
    },
    ...
    c.viewDate = function(a, b, d) {
        ...
        function(a, b) {
            ...
            e = f.ymd[1] + 1;
            b.className = "",
            a < f.FDay ? (b.innerHTML = g = a + f.PDay, c.addClass(b, "laydatex_nothis"), 1 === e && (d -= 1), e = 1 === e ? 12 : e - 1) : a >= f.FDay && a < f.FDay + c.months[f.ymd[1]] ? (b.innerHTML = g = a - f.FDay + 1, a - f.FDay + 1 === f.ymd[2] && (c.addClass(b, h[2]), f.thisDay = b)) : (b.innerHTML = g = f.NDay++, c.addClass(b, "laydatex_nothis"), 12 === e && (d += 1), e = 12 === e ? 1 : e + 1),
    ...
    c.viewYears = function(a) {
        ...
        b("#laydatex_ys").innerHTML = d,
        c.each(b("#laydatex_ys li"),
        function(a, b) {
    ...
    c.viewtb = function() {
        ...
        i.id = i.className = "laydatex_table",
        a = b = null,
    ...
    c.view = function(a, f) {
        ...
        c.box ? c.shde(c.box) : (i = d[e]("div"), i.id = h[0], i.className = h[0], i.style.cssText = "position: absolute;", i.setAttribute("name", "laydatex-v" + laydatex.v), i.innerHTML = j.html = '<div class="laydatex_top"><div class="laydatex_ym laydatex_y" id="laydatex_YY"><a class="laydatex_choose laydatex_chprev laydatex_tab"><cite></cite></a><input id="laydatex_y" readonly><label></label><a class="laydatex_choose laydatex_chnext laydatex_tab"><cite></cite></a><div class="laydatex_yms"><a class="laydatex_tab laydatex_chtop"><cite></cite></a><ul id="laydatex_ys"></ul><a class="laydatex_tab laydatex_chdown"><cite></cite></a></div></div><div class="laydatex_ym laydatex_m" id="laydatex_MM"><a class="laydatex_choose laydatex_chprev laydatex_tab"><cite></cite></a><input id="laydatex_m" readonly><label></label><a class="laydatex_choose laydatex_chnext laydatex_tab"><cite></cite></a><div class="laydatex_yms" id="laydatex_ms">' +
        function() {
            var a = "";
            ...
            a
        } () + "</div>" + "</div>" + "</div>" + c.viewtb + '<div class="laydatex_bottom">' + '<ul id="laydatex_hms">' + '<li class="laydatex_sj">时间</li>' + "<li><input readonly><span hidden>:</span></li>" + "<li><input readonly hidden><span hidden>:</span></li>" + "<li><input readonly hidden></li>" + "</ul>" + '<div class="laydatex_time" id="laydatex_time"></div>' + '<div class="laydatex_btn">' + '<a id="laydatex_clear">清空</a>' + '<a id="laydatex_today">今天</a>' + '<a id="laydatex_ok">确认</a>' + "</div>" + (b.isv ? '<a href="http://sentsin.com/layui/laydatex/" class="laydatex_v" target="_blank">laydatex-v' + laydatex.v + "</a>": "") + "</div>", d.body.appendChild(i), c.box = g("#" + h[0]), c.events(), i = null),
        c.follow(c.box),
    ...
    c.reshow = function() {
        return c.each(c.query("#" + h[0] + " .laydatex_show"),
        function(a, b) {
            c.removeClass(b, "laydatex_show")
        }),
        this
    },
    c.close = function() {
    ...
    c.events = function() {
        ...
        c.addClass(d.body, "laydatex_body"),
        h.tds = b("#laydatex_table td"),
        h.mms = b("#laydatex_ms span"),
        h.year = b("#laydatex_y"),
        h.month = b("#laydatex_m"),
        c.each(b(e.box + " .laydatex_ym"),
        function(a, b) {
            c.on(b, "click",
            function(b) {
                c.stopmp(b).reshow(),
                c.addClass(this[g]("div")[0], "laydatex_show"),
        ...
        c.each(b("#laydatex_YY .laydatex_tab"),
        function(a, b) {
            c.on(b, "click",
            function(b) {
                c.stopmp(b),
        ...
        c.each(b("#laydatex_MM .laydatex_tab"),
        function(a, b) {
            c.on(b, "click",
            function(b) {
                c.stopmp(b).reshow(),
        ...
        e.times = b("#laydatex_time"),
        c.hmsin = e.hmsin = b("#laydatex_hms input"),
        e.hmss = ["小时", "分钟", "秒数"],
        e.hmsarr = [],
        c.msg = function(a, d) {
            var f = '<div class="laydte_hsmtex">' + (d || "提示") + "<span>×</span></div>";
            "string" == typeof a ? (f += "<p>" + a + "</p>", c.shde(b("#" + h[0])), c.removeClass(e.times, "laydatex_time1").addClass(e.times, "laydatex_msg")) : (e.hmsarr[a] ? f = e.hmsarr[a] : (f += '<div id="laydatex_hmsno" class="laydatex_hmsno">', c.each(new Array(0 === a ? 24 : 60),
            function(a) {
                f += "<span>" + a + "</span>"
            }), f += "</div>", e.hmsarr[a] = f), c.removeClass(e.times, "laydatex_msg"), c[0 === a ? "removeClass": "addClass"](e.times, "laydatex_time1")),
            c.addClass(e.times, "laydatex_show"),
            e.times.innerHTML = f
        },
        e.hmson = function(a, d) {
            var e = b("#laydatex_hmsno span"),
            f = c.valid ? null: 1;
            c.each(e,
            function(b, e) {
            ...
            c.addClass(e[0 | a.value], "laydatex_click")
        },
        c.each(e.hmsin,
        function(a, b) {
            c.on(b, "click",
    ...
    laydatex.reset = function() {
        c.box && c.elem && c.follow(c.box)
    },
    laydatex.now = function(a, b) {
        var d = new Date(0 | a ?
        function(a) {
